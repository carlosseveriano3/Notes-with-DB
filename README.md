...
The application consists of creating and receiving notes with RabbitMQ, storing them in MongoDB, caching with Redis and being able to retrieve later through an HTTP request.
